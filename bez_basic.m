%% Border controllpontok megadása
xlim_min = -2;
ylim_min= -3
xlim_max = 8;
ylim_max= 8;

% itt elkezdjük a középsõ sáv megadását:
...
% soronként egy szegmens kontrollpontjai pl.: 3 szegmensnél: 3 sorból áll, 1 sor: [x1 y1 x2 y2
% x3y3 ]

for i=1:(number_of_segment)                   % Végigfutunk az összes szegmensen
